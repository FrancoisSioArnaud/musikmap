...
SONGS_BY_USER = {
    ...
    "max.jazzy": [
        ...
        {"title": "Harder Than You Think", "artist": "Public Enemy"},
    ],
    "emma.orbit": [
    ...
    "lucas.verso": [
        ...
        {"title": "92i Veyron", "artist": "Booba"},
        {"title": "La puissance", "artist": "Rohff"},
        {"title": "Mwaka Moon", "artist": "Kalash"},
    ],
    "nina.silk": [
...
COMMENTS_PER_USER = 3
COMMENT_REASON_CODE = "seed_test_comment"
REACTION_USER_AGENT = "seed_test_script"
COMMENT_USER_AGENT = "seed_test_script"

COMMENT_TEXTS = [
    "Parfait pour courir.",
    "Ça motive direct.",
    "Bon morceau pour une séance.",
    "Je le mets dans ma playlist sport.",
    "Très bon rythme.",
    "Ça donne envie de bouger.",
    "Gros boost d'énergie.",
    "Idéal pour le cardio.",
    "Je valide pour l'entraînement.",
    "Ça passe trop bien en échauffement.",
    "Bonne pioche pour une session intense.",
    "Le tempo est parfait.",
    "Ça relance direct.",
    "Très bon son pour se dépasser.",
    "Je le garde pour ma prochaine séance.",
    "Énergie immédiate.",
    "Très efficace pour rester dans le rythme.",
    "Bonne découverte sport.",
]
