...
urlpatterns = [
    ...
    path("box-older-deposits/", BoxOlderDepositsView.as_view(), name="box-older-deposits"),
    ...
    path("comments/deposit/<str:dep_public_key>/", DepositRepliesView.as_view(), name="comments-deposit-replies"),
