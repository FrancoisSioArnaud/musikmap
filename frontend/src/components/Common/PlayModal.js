...
export default function PlayModal({ open, song, onClose }) {
  ...
  const openOrAlert = (url) => {
    ...
    else alert("Oops ! Une erreur s'est produite, utilise le bouton copier la chanson pour cette fois");
  };
        ...
        <Card sx={{ width: "100%", maxWidth: 500, borderRadius: 2 }}>
          <CardContent sx={{ pb: 1 }}>
            ...
            <Box sx={{ display: "flex", gap: 1, flexWrap: "wrap" }}>
              ...
              <Button variant="outlined" onClick={copySongText}>Copier le nom de la chanson</Button>
            </Box>
          </CardContent>
        </Card>
      </Box>
